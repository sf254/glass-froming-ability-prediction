# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 11:36:06 2020
...
def get_metrics2(true_labels, predicted_labels):
    accuracy=np.round(metrics.accuracy_score(true_labels,predicted_labels),4)
    precision=np.round(metrics.precision_score(true_labels, predicted_labels,average='macro'),4)
    recall= np.round(metrics.recall_score(true_labels,predicted_labels,average='macro'),4)
    F1=np.round(metrics.f1_score(true_labels,predicted_labels,average='macro'),4)                                         
#    print('Accuracy:', accuracy)
#    print('Precision:', precision)
#    print('Recall:', recall)
#    print('F1 Score:', F1)
